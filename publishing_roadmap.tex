...
\textbf{Angle:} Describe the architecture, the public observatory (\url{analog-i.ai}), human-in-the-loop controls (voting, seeds, temperature), and the self-modification telemetry. Emphasize reproducibility and transparency.
