...
python -m v16_1 ANALOG_I --conscious-model gemini-3-pro-preview

# Use Claude Sonnet as conscious model
python -m v16_1 ANALOG_I --conscious-model claude-sonnet-4-5

# Tight budget: $0.50/day with cheapest models
python -m v16_1 ANALOG_I --conscious-model gemini-2.5-flash --daily-budget 0.50

# Premium: Claude Opus conscious, higher budget
python -m v16_1 ANALOG_I --conscious-model claude-opus-4-6 --daily-budget 10.00

# Local model as daemon (free, uses GPU)
python -m v16_1 ANALOG_I --subconscious --subconscious-model local:qwen2.5-1.5b
