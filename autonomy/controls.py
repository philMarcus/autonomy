...
def build_default_registry(model_registry, blacklist_str: str = "") -> ControlRegistry:
    ...
    controls = [
        ...
        Control("muse_model_weights", "weights",
                "ollama:gemma4:12b=2,ollama:deepseek-r1:8b=1,ollama:qwen3.5:9b=0,ollama:phi4:latest=0,ollama:llama3.2:3b=0,ollama:qwen2.5:1.5b=0",
        ...
        Control("dream_interval_ticks", "int", 10,
                "Average ticks between dreams (stochastic)", "daemon", min_val=1, max_val=1000),
        Control("muse_interval_ticks", "int", 10,
                "Average ticks between muse creative drafts (stochastic)", "daemon", min_val=1, max_val=500),
