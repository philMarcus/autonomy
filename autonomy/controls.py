...
def build_default_registry(args, model_registry) -> ControlRegistry:
    ...
    controls = [
        ...
        Control("subconscious_model_weights", "weights",
                ...
                "Weighted model pool for SENTRY scoring (cheap/local)", "llm",
                choices=subconscious_choices),
        Control("strategist_model_weights", "weights",
                "mistral-small-latest=3,local:qwen2.5-1.5b=2",
                "Weighted model pool for STRATEGIST drafts (JSON-capable)", "llm",
                choices=subconscious_choices),
