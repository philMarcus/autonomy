...
def build_default_registry(args, model_registry) -> ControlRegistry:
    ...
    controls = [
        ...
        Control("wake_decay_rate", "float", 0.95,
                "Per-tick charge decay", "daemon", min_val=0.5, max_val=1.0),
        Control("dream_depth", "int", 5,
                "Memories to compress per dream", "daemon", min_val=1, max_val=20),
