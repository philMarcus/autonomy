...
class MoltbookClient:
    def __init__(self, api_key: str, telemetry: Optional[TelemetryLogger]=None, brain_name: str = "", read_only: bool = False):
...
def main():
    ...
    client = MoltbookClient(MOLTBOOK_API_KEY, telemetry=TELEMETRY, brain_name=brain_name, read_only=bool(getattr(args,'read_only',False)))
