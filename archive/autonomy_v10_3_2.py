...
def main():
    ...
    TELEMETRY = TelemetryLogger(brain_name=brain_name, run_id=RUN_ID, base_dir=os.environ.get("TELEMETRY_DIR", "telemetry").strip() or "telemetry", read_only=getattr(args, 'read_only', False))
